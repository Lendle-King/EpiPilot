...
EVENT_PAYLOAD_TYPES: dict[EventType, type[EventPayload]] = {
    ...
    EventType.UNKNOWN_RESOLVED: UnknownResolvedPayload,
    EventType.HYPOTHESIS_CREATED: HypothesisCreatedPayload,
    EventType.HYPOTHESIS_UPDATED: HypothesisUpdatedPayload,
    EventType.EXPERIMENT_PREREGISTERED: ExperimentPreregisteredPayload,
    EventType.EXPERIMENT_CONCLUDED: ExperimentConcludedPayload,
